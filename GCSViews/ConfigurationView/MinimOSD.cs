...
{
    public partial class MinimOSD : UserControl, IActivate
    {
        ...
        void setupFunctions()
        {
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("中心", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("俯仰", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("横滚", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电压", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 卫星数", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 锁定", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 坐标", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            //second 8
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("朝向转盘", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("朝向度数", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("心跳", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("家的方向", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("家的距离", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("航点方向", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("航点距离", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR);
            // rssi
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("相对家的高度", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("爬升率", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电池百分比", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电流", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("空速", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("油门", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("飞行模式", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("地平线", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR);
            
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("风速", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR);
            ...
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("时间", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("信号强度", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("调试", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("效率", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("呼号", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR);
            panelItems[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("遥控通道数据", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR);
            ...
            foreach (var thing in panelItems)
            {
                if (thing != null)
                {
                    ...
                    else if (thing.Item1 == "调试")
                    {
                        LIST_items.Items.Add(thing.Item1, false);

                    }
                    else if (thing.Item1 == "遥控通道数据")
                    {
                        LIST_items.Items.Add(thing.Item1, false);
            ...
            // first 8
            // Display name,printfunction,X,Y,ENaddress,Xaddress,Yaddress
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("中心", pan.panCenter, 13, 8, panCenter_en_ADDR, panCenter_x_ADDR, panCenter_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("俯仰", pan.panPitch, 22, 10, panPitch_en_ADDR, panPitch_x_ADDR, panPitch_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("横滚", pan.panRoll, 11, 1, panRoll_en_ADDR, panRoll_x_ADDR, panRoll_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电压", pan.panBatt_A, 1, 13, panBatt_A_en_ADDR, panBatt_A_x_ADDR, panBatt_A_y_ADDR);
            //items[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("Battery B", pan.panBatt_B, 21, 3, panBatt_B_en_ADDR, panBatt_B_x_ADDR, panBatt_B_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 卫星数", pan.panGPSats, 1, 9, panGPSats_en_ADDR, panGPSats_x_ADDR, panGPSats_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 锁定", pan.panGPL, 1, 10, panGPL_en_ADDR, panGPL_x_ADDR, panGPL_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("GPS 坐标", pan.panGPS, 1, 14, panGPS_en_ADDR, panGPS_x_ADDR, panGPS_y_ADDR);

            //second 8
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("朝向转盘", pan.panRose, 17, 14, panRose_en_ADDR, panRose_x_ADDR, panRose_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("朝向度数", pan.panHeading, 24, 13, panHeading_en_ADDR, panHeading_x_ADDR, panHeading_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("心跳", pan.panMavBeat, 14, 15, panMavBeat_en_ADDR, panMavBeat_x_ADDR, panMavBeat_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("家的方向", pan.panHomeDir, 14, 3, panHomeDir_en_ADDR, panHomeDir_x_ADDR, panHomeDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("家的距离", pan.panHomeDis, 22, 1, panHomeDis_en_ADDR, panHomeDis_x_ADDR, panHomeDis_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("航点方向", pan.panWPDir, 20, 12, panWPDir_en_ADDR, panWPDir_x_ADDR, panWPDir_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("航点距离", pan.panWPDis, 20, 11, panWPDis_en_ADDR, panWPDis_x_ADDR, panWPDis_y_ADDR);
            // rssi
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("相对家的高度", pan.panHomeAlt, 22, 2, panHomeAlt_en_ADDR, panHomeAlt_x_ADDR, panHomeAlt_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("爬升率", pan.panClimb, 1, 7, panClimb_en_ADDR, panClimb_x_ADDR, panClimb_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电池百分比", pan.panBatteryPercent, 1, 5, panBatteryPercent_en_ADDR, panBatteryPercent_x_ADDR, panBatteryPercent_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("电流", pan.panCur_A, 1, 12, panCur_A_en_ADDR, panCur_A_x_ADDR, panCur_A_y_ADDR);
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("空速", pan.panAirSpeed, 1, 1, panAirSpeed_en_ADDR, panAirSpeed_x_ADDR, panAirSpeed_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("油门", pan.panThr, 1, 4, panThr_en_ADDR, panThr_x_ADDR, panThr_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("飞行模式", pan.panFlightMode, 18, 13, panFMod_en_ADDR, panFMod_x_ADDR, panFMod_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("地平线", pan.panHorizon, 8, 6, panHorizon_en_ADDR, panHorizon_x_ADDR, panHorizon_y_ADDR);

            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("风速", pan.panWindSpeed, 24, 7, panWindSpeed_en_ADDR, panWindSpeed_x_ADDR, panWindSpeed_y_ADDR);
            ...
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("时间", pan.panTime, 22, 4, panTime_en_ADDR, panTime_x_ADDR, panTime_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("信号强度", pan.panRSSI, 12, 12, panRSSI_en_ADDR, panRSSI_x_ADDR, panRSSI_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("调试", pan.panTune, 1, 1, panTune_en_ADDR, panTune_x_ADDR, panTune_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("效率", pan.panEff, 1, 3, panEff_en_ADDR, panEff_x_ADDR, panEff_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("呼号", pan.panCALLSIGN, 1, 0, panCALLSIGN_en_ADDR, panCALLSIGN_x_ADDR, panCALLSIGN_y_ADDR);
            panelItems2[a++] = new Tuple<string, Func<int, int, int>, int, int, int, int, int>("遥控通道数据", pan.panCh, 1, 0, panCh_en_ADDR, panCh_x_ADDR, panCh_y_ADDR);
                ...
                foreach (var thing in panelItems)
                {
                    ...
                    if (thing != null)
                    {
                        if (thing.Item1 == it)
                        {
                            ...
                            if (thing.Item4 >= getCenter() && ! (pan.pal_ntsc == 1))
                            {
        ...
        private void checkedListBox1_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            if (((CheckedListBox)sender).SelectedItem != null)
            {
                ...
                {
                    int index = LIST_items.Items.IndexOf("中心");
                    LIST_items.SetItemChecked(index, false);
                }
                else if (((CheckedListBox)sender).SelectedItem.ToString() == "中心" && e.NewValue == CheckState.Checked)
                {
        ...
        private void checkedListBox2_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            if (((CheckedListBox)sender).SelectedItem != null)
            {
                if (((CheckedListBox)sender).SelectedItem.ToString() == "地平线" && e.NewValue == CheckState.Checked)
                {
                    int index = LIST_items2.Items.IndexOf("中心");
        ...
        private void BUT_WriteOSD_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sp = new ArduinoSTK();
                sp.PortName = MainV2.comPortName;// CMB_ComPort.Text;
                sp.BaudRate = 57600;
                sp.DataBits = 8;
            ...
            if (sp.connectAP())
            {
                try
                {
                    ...
                    if (current.Name == "tabPage1")
                    {
                        ...
                        if (spupload_flag) MessageBox.Show("写入页面 1 数据成功!");
                        else MessageBox.Show("写入页面 1 数据失败");
                    }
                    else if (current.Name == "tabPage2")
                    {
                        for (int i = 0; i < 10; i++)
                        ...
                        if (spupload_flag) MessageBox.Show("写入页面 2 数据成功!");
                        else MessageBox.Show("写入页面 2 数据失败");
                    }
                    else if (current.Name == "tabPageConfig")
                    {
                        for (int i = 0; i < 10; i++)
                        ...
                        if (spupload_flag) MessageBox.Show("写入配置数据成功!");
                        else MessageBox.Show("写入配置数据失败");
                    } 
                }                 
                catch (Exception ex) {
        ...
        private void BUT_ResetOSD_EEPROM()
        {
            ...
            foreach (string str in this.LIST_items.Items)
            {
                foreach (var tuple in this.panelItems_default)
                {
                    if ((tuple != null) && ((tuple.Item1 == str)) && tuple.Item5 != -1)
                    {
                        if (str == "中心") eeprom[tuple.Item5] = 0;
                        else if (str == "调试") eeprom[tuple.Item5] = 0;
                        else if (str == "遥控通道数据") eeprom[tuple.Item5] = 0;
        ...
        private void BUT_ReadOSD_Click(object sender, EventArgs e)
        {
            ...
            if (sp.down_flag) MessageBox.Show("下载数据成功!");
        ...
        {
            toolStripStatusLabel1.Text = "上传中 " + progress + " %";
        ...
        private void pictureBox1_MouseMove(object sender, MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left && mousedown[0] == true)
            {
                ...
                if (ansH >= getCenter() && !(pan.pal_ntsc == 1))
                {
                    ansH += 3;
                }
        ...
        private void sendTLogToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.FileName != "")
            {
                ...
                try
                {
                    ...
                    comPort.PortName = MainV2.comPortName;// CMB_ComPort.Text;
        ...
        private void xmlconfig(bool write)
        {
            if (write || !File.Exists(Path.GetDirectoryName(Application.ExecutablePath) + Path.DirectorySeparatorChar + @"config.xml"))
            {
                try
                {
                    ...
                    xmlwriter.WriteElementString("comport", MainV2.comPortName);//CMB_ComPort.Text);

                    xmlwriter.WriteElementString("Pal", (pan.pal_ntsc == 1).ToString());
        ...
        {
            tabPage2.Size = tabPage1.Size;
        }

        private void tabPage2_SizeChanged(object sender, EventArgs e)
        {
            tabPage1.Size = tabPage2.Size;
        }

        private void videoModeToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            if (comboBoxPN.SelectedIndex == 0)
                pan.pal_ntsc = 1;
            else
                pan.pal_ntsc = 0;

            changeToPal((pan.pal_ntsc == 1));
            osdDraw1();
            osdDraw2();
        }
        ...
        private void BUT_FIRM_Click(object sender, EventArgs e)
        {
            toolStripProgressBar1.Style = ProgressBarStyle.Continuous;
            this.toolStripStatusLabel1.Text = "";
                ...
                using (var stream = ofd.OpenFile())
                {
                    ...
                    while (br.BaseStream.Position < br.BaseStream.Length && !this.IsDisposed)
                    {
                        try
                        {
                            ...
                            toolStripStatusLabel1.Text = "字符上传中";
                    ...
                    toolStripStatusLabel1.Text = "上传字符成功";
                }
            }
        }

        private void tabPageConfig_SizeChanged(object sender, EventArgs e)
        {
            tabPage1.Size = tabPageConfig.Size;
            tabPage2.Size = tabPageConfig.Size;
        }
